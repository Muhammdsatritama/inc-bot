...
`.trim(), m.message, {
  ...
  async onCall(json) {
    ...
    await this.sendMessage(from, 'Karena kamu Menelpon bot, kamu akan diblok secara Otomatis...', MessageType.extendedText)
...
global.dfail = (type, m, conn) => {
  let msg = {
    rowner: '_*OWNER*_ Only!!!',
    owner: 'Perintah ini hanya dapat digunakan oleh _*Owner Bot*_!',
    mods: '*Moderate* Only!!!',
    premium: '*Premium* Only!!! Ketik  _*#getprem*_  untuk Upgrade',
    group: '*Group* Only!!!',
    private: 'Only *Private Chat*!!!',
    admin: '*Admin Group* Only!!!',
    botAdmin: 'Jadikan bot sebagai *Admin* untuk menggunakan perintah ini!',
    unreg: 'Silahkan daftar untuk menggunakan fitur ini dengan cara mengetik:\n\n*#daftar nama.umur*\n\nContoh: *#daftar Tamz.16*'
  }[type]
